package com.kryzedev.kryzemobs.server.entity.Hunter;
...
/**
 * Created by KryzeDev on 30/8/2021.
 */

public class EntityHunter extends KryzeEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public EntityHunter(EntityType<? extends KryzeEntity> type, World worldIn) {
        super(type, worldIn);
    }
